...
import { Route as SrcRoutesAdminIndexRouteImport } from './routes/src/routes/admin.index'
...
const SrcRoutesAdminIndexRoute = SrcRoutesAdminIndexRouteImport.update({ id: '/src/routes/admin/', path: '/src/routes/admin/', getParentRoute: () => rootRouteImport } as any)
