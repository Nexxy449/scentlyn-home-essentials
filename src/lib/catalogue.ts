...
export async function getCatalogue():Promise<Catalogue>{
  // A deployment with missing Supabase browser configuration must still render
  // the storefront. Once the environment variables are present, the database
  // remains the source of truth for live products, variants and stock.
