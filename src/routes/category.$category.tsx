    ...
    <div className="bg-background">
      <section className="border-b border-border/60 bg-surface/60">
        <div className="mx-auto max-w-7xl px-4 py-9 sm:px-6 md:py-12 lg:px-8">
          ...
          <div className="mt-6"><p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-brand">Shop {category.name}</p><h1 className="mt-3 font-display text-4xl font-bold tracking-tight sm:text-5xl">{category.name}</h1></div>
        </div>
      </section>
