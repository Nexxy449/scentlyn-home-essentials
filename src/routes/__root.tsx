  ...
  head: () => ({
    meta: [
      ...
      { title: "Scentlyn — Laundry, Home Care & Scents in Kenya" },
      {
        name: "description",
        content:
          "Premium laundry, cleaning and home fragrance products delivered across Kenya. Shop by category or order instantly on WhatsApp.",
      },
      { name: "author", content: "Scentlyn" },
